...
router.get('/delete/:id_plaza', isLoggedIn, async (req, res) => {
...
router.get('/edit/:id_plaza', isLoggedIn, async (req, res) => {
    const {id_plaza} = req.params;  
...
router.post('/edit/:id_plaza', isLoggedIn, async (req,res) =>{
    const { id_plaza } = req.params; 
    const {localizacion, tipo_servicio,nivel,estado } = req.body;
    const newPlaza2 = {
        localizacion,
